...
export default function HomePage() {
  ...
  return (
    <main className="flex min-h-screen w-screen flex-col overflow-x-hidden bg-gradient-to-b from-[#2e026d] to-[#15162c] text-white md:h-screen md:flex-row md:min-h-max">
      <div className="flex h-full w-screen flex-col items-center p-3 md:flex-row md:justify-center md:p-8">
        ...
        <div className="order-2 mt-8 flex h-fit w-fit flex-col justify-center md:order-1 md:mt-8 md:gap-14 md:p-24">
          ...
          <p className="mt-4 md:text-md md:mr-16 md:text-2xl">
          ...
          <div className="my-4 text-xl font-bold text-white md:text-4xl">
            {userName === "Guest" ? (
              <p>Welcome, Guest! Sign in to buy Tshirt and other merchendise.</p>
            ) : (
